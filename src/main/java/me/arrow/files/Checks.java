...
public class Checks implements Initializer {
    ...
    public enum Setting {
        ...
        REACH_A_RAY("ReachA.requireRayForReach", true, "Do not touch this if you don't know what you are doing."),
        ...
        HITBOX_A_PUNiSH_MODE("HitboxA.punish.mode", "BAN", "What punish mode should we use for this check (KICK or BAN)"),
        HITBOX_A_MAX_VL("HitboxA.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        BACKTRACK_A_MAX_VL("BackTrackA.punish.vl", 100, "The maximum violation amount a player needs to reach in order to get punished"),

        BACKTRACK_B("BackTrackB.enabled", true, "Should we enable this module?"),
        BACKTRACK_B_PUNISH("BackTrackB.punish", "", "Punishment settings"),
        BACKTRACK_B_PUNiSH_ENABLED("BackTrackB.punish.enabled", false, "Should punishments be enabled for this check?"),
        BACKTRACK_B_PUNiSH_MODE("BackTrackB.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        BACKTRACK_B_MAX_VL("BackTrackB.punish.vl", 200, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        AUTOCLICKER_A_PUNiSH_ENABLED("AutoClickerA.punish.enabled", false, "Should punishments be enabled for this check?"),
        ...
        INTERACT_C_PUNiSH_MODE("InteractC.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        INTERACT_C_MAX_VL("InteractC.punish.vl", 20, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        INVENTORY_C_MAX_VL("InventoryC.punish.vl", 20, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        SCAFFOLD_A_MAX_VL("ScaffoldA.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),

        ANALYSIS_A("AnalysisA.enabled", false, "Should we enable this module?"),
        ANALYSIS_A_MODE("AnalysisA.mode", CheckMode.FLAG.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ANALYSIS_A_PUNISH("AnalysisA.punish", "", "Punishment settings"),
        ANALYSIS_A_PUNiSH_ENABLED("AnalysisA.punish.enabled", false, "Should punishments be enabled for this check?"),
        ANALYSIS_A_PUNiSH_MODE("AnalysisA.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        ANALYSIS_A_MAX_VL("AnalysisA.punish.vl", 30, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        SPEED_B_MAX_VL("SpeedB.punish.vl", 5, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        SPEED_C_MAX_VL("SpeedC.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        OMNISPRINT_A_MAX_VL("OmniSprintA.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        GROUND_A_PUNiSH_MODE("GroundA.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        GROUND_A_MAX_VL("GroundA.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        GROUND_B_MAX_VL("GroundB.punish.vl", 5, "The maximum violation amount a player needs to reach in order to get punished"),

        GROUND_C("GroundC.enabled", true, "Should we enable this module? (THIS IS THE GHOSTBLOCK HANDLER)"),
        GROUND_C_MODE("GroundC.mode", CheckMode.MITIGATE.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        ELYTRA_A_PUNiSH_ENABLED("ElytraA.punish.enabled", true, "Should punishments be enabled for this check?"),
        ...
        FLY_A_MAX_VL("FlyA.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),

        FLY_B("FlyB.enabled", true, "Should we enable this module?"),
        FLY_B_MODE("FlyB.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        FLY_B_MAX_VL("FlyB.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),

        FLY_C("FlyC.enabled", true, "Should we enable this module?"),
        FLY_C_MODE("FlyC.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        FLY_C_MAX_VL("FlyC.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),

        FLY_D("FlyD.enabled", true, "Should we enable this module?"),
        FLY_D_MODE("FlyD.mode", CheckMode.FLAG.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        FLY_D_PUNISH("FlyD.punish", "", "Punishment settings"),
        FLY_D_PUNiSH_ENABLED("FlyD.punish.enabled", true, "Should punishments be enabled for this check?"),
        FLY_D_PUNiSH_MODE("FlyD.punish.mode", "BAN", "What punish mode should we use for this check (KICK or BAN)"),
        FLY_D_MAX_VL("FlyD.punish.vl", 25, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        MOTION_B_MAX_VL("MotionB.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),

        MOTION_C("MotionC.enabled", true, "Should we enable this module?"),
        MOTION_C_MODE("MotionC.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_C_MAX_VL("MotionC.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        MOTION_D_MAX_VL("MotionD.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        MOTION_F_MODE("MotionF.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_F_PUNiSH_MODE("MotionF.punish.mode", "BAN", "What punish mode should we use for this check (KICK or BAN)"),
        MOTION_F_MAX_VL("MotionF.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),

        MOTION_G("MotionG.enabled", true, "Should we enable this module?"),
        MOTION_G_MODE("MotionG.mode", CheckMode.FLAG.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        MOTION_G_PUNISH("MotionG.punish", "", "Punishment settings"),
        MOTION_G_PUNiSH_ENABLED("MotionG.punish.enabled", false, "Should punishments be enabled for this check?"),
        MOTION_G_PUNiSH_MODE("MotionG.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        MOTION_G_MAX_VL("MotionG.punish.vl", 25, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        TIMER_A_PUNiSH_MODE("TimerA.punish.mode", "BAN", "What punish mode should we use for this check (KICK or BAN)"),
        ...
        BADPACKETS_B_PUNiSH_MODE("BadPacketsB.punish.mode", "KICK", "What punish mode should we use for this check (KICK or BAN)"),
        BADPACKETS_B_MAX_VL("BadPacketsB.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        BADPACKETS_D_MODE("BadPacketsD.mode", CheckMode.FLAG.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        BADPACKETS_E_MODE("BadPacketsE.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        BADPACKETS_E_MAX_VL("BadPacketsE.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        NOSLOWDOWN_A_PUNiSH_ENABLED("NoSlowdownA.punish.enabled", true, "Should punishments be enabled for this check?"),
        ...
        VEHICLE_A_MAX_VL("VehicleA.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished");
